              ...
              <div className="bg-white dark:bg-[#1a1a1d]">
                <article className="w-full px-2 sm:px-4 md:px-8 lg:px-16">
                  <iframe
                    ...
                    src="/demo"
                    frameBorder="0"
                    className="w-full hidden sm:block h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px]"
                    title="Dashboard Demo"
                    allowFullScreen
                  />
                  <img src="/images/dashboard.png" alt="Dashboard Demo" className="w-full h-auto sm:hidden" />
                </article>
              </div>
            </article>
          </div>
